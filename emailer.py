...
class Emailer():
    ...
    def dailyEmail( user ):
        ...
        body     = """ <html> <head><style type="text/css"> body {background-image: url("http://www.triv-bot.appspot.com/images/question_grey3.png");
        ...
        href="http://www.triv-bot.appspot.com"><img height="25px" src="http://www.triv-bot.appspot.com/images/logo_no.png" alt="TrivBot"></img></a> today
        to increase your score!</p><p>Remember: if you PASS, you still get points!</p><p> -- TrivBot Team</p> </div><div><a href="http://www.triv-bot.appspot.com"><img alt="TrivBot" height="100px" src="http://www.triv-bot.appspot.com/images/logo_bot5.png"></a></img></div> 
        </center></body> </html> 
